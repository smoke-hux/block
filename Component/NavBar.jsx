...
import { Nav1, Nav2, Nav3, NavBar } from "../Component/index";

export default () => {
  const [state, setState] = useState(false);
  const { currentUser, connetWallet } = useContext(Trackingcontext);
      ...
      >
        <ul className="justify-center items-center space-y-8 md:flex md:space-x-6 md:space-y-0">
          {navigation.map((item, idx) => {
            return(
              <li key={idx} className="text-gray700 hover:text-gray-900">
